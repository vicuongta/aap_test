        ...
        <div className="flex flex-col md:flex-row justify-between gap-12">
          ...
          <div className="max-w-sm">
            ...
            <p className="text-sm text-neutral-400 mb-8 leading-relaxed">
              QBtron helps you manage your academic life with intelligence and ease.
            </p>
            <div className="flex gap-3">
              <Button className="bg-[#2d6a4f] hover:bg-[#40916c] text-white rounded-full">
                Explore
              </Button>
              <Button
                variant="ghost"
          ...
          <div className="flex flex-col justify-center gap-8">
            ...
            <div className="flex gap-4">
              ...
              <a href="mailto:contact@qbtron.com" className="text-neutral-400 hover:text-white transition-colors">
